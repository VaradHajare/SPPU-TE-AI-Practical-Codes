# LP-II, Part I: Artificial Intelligence

This folder contains the laboratory experiments for **LP-II, Part I: Artificial Intelligence** as per the Third Year Computer Engineering 2019 Course syllabus of Savitribai Phule Pune University.

## Practical List

| Sr. No. | Group | Assignment | File |
| --- | --- | --- | --- |
...
Solves the N-Queens problem using Backtracking and Branch and Bound. The solution is displayed in a grid board format.

### Practical 5: Chatbot

Implements an elementary chatbot for customer interaction.

### Practical 6: Expert System

Implements an expert system for a selected application domain.
...
Run any practical using Python:

```bash
python practical-1.py
python practical-2.py
python practical-3.py
python practical-4.py
python practical-5.py
python practical-6.py
```

## Notes

- All assignments are compulsory.
- Group A contains Practical 1, 2, and 3.
- Group B contains Practical 4 and 5.
- Group C contains Practical 6.